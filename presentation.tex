...
\begin{frame}[t]{Deterministic Metric}
\raggedright
Reference keys:
\[
K_G = \bigcup_i K(G_i)
...
Precision:
\[
\mathrm{KeyPrecision} = \frac{|K_P \cap K_G|}{|K_P|},
\]
Recall:
\[
\mathrm{KeyRecall} = \frac{|K_P \cap K_G|}{|K_G|},
\]
F1:
\[
\mathrm{KeyF1} =
\frac{2 \cdot \mathrm{KeyPrecision} \cdot \mathrm{KeyRecall}}
{\mathrm{KeyPrecision} + \mathrm{KeyRecall}}.
\]
\end{frame}
